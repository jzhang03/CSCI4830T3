...
public class UtilProp_Zhang {
   static final boolean _W = System.getProperty("os.name").toLowerCase().contains("windows");
   static String _PROP_FILENAME_WIN_LOCAL = "C:\\Users\\skill\\Desktop\\workspace_CSCI4830_0219\\webproject_Q2_Zhang_0219\\WebContent\\config.properties";
